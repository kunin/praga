...
(function(a) {
   ...
   c) {
      ...
      var e = {
         currentSlide : 0, currentImage : "", totalSlides : 0, running : false, paused : false, stop : false, controlNavEl : false}; 
      var f = a(b); 
      ...
      if(a(g[e.currentSlide]).is("a")) {
         a(g[e.currentSlide]).css("display", 
         "block")}
      ...
      if(d.directionNav) {
		 ...
		 f.append('<img src="images/slider11.png" alt="" class="frame1" />');
         a("a.nivo-prevNav", 
         f).live("click", 
         function() {
            if(e.running) {
      ...
      if(d.controlNav) {
         ...
         e.controlNavEl).addClass("active"); 
      ...
      c, d) {
         ...
         "block"); 
         a('img[src="' + d.currentImage.attr("src") + '"]', 
         b).not(".nivo-main-image,.nivo-control img").width(b.width()).css("visibility", 
         "hidden").show(); 
         var e = a('img[src="' + d.currentImage.attr("src") + '"]', 
         ...
         b).not(".nivo-main-image,.nivo-control img").height(); 
      ...
      c, d) {
         ...
         b).not(".nivo-main-image,.nivo-control img").height() / c.boxRows); 
      ...
      c, d, e) {
         ...
         if(d.controlNav) {
            a("a", 
            f.controlNavEl).removeClass("active"); 
            a("a:eq(" + f.currentSlide + ")", 
      ...
      var p = function(a) {
         for(var b, 
         c, d = a.length; d; b = parseInt(Math.random() * d, 10), c = a[--d], a[d] = a[b], a[b] = c); 
         return a}; 
      var q = function(a) {
